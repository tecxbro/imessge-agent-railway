...
- [Deploy the agent](./DEPLOYMENT.md) — create the Railway resources, authenticate providers, and send the first iMessage.
...
The executable production runtime is composed. A clean-account Railway deployment and protected live-provider evidence must still be recorded for each release under review.
